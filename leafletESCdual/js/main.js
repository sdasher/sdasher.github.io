$(document).ready(function() {
    ...
    $.getJSON("/data/convertedregionsfinal.geojson")
      .done(function(data) {
        ...
        createSliderUI(map, info.timestamps);
    ...
    function createSliderUI(map, timestamps) {

      var sliderControl = L.Control.extend({options: {
        position: 'bottomleft'
      },
...
$(container).on(container, 'mousedown', function(e){
          L.DomEvent.stopPropagation(e);
        });
        ...
        ontainer.addEventListener('mouseout', function (){
          map.dragging.enable();
        });
